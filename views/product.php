        ...
        <?php if (@$result && @$result->num_rows > 0) : ?>
            <div class="w-full h-full flex justify-start pt-[3rem]  gap-20">
                <div class="w-[10rem] flex flex-col">
                    <img class="w-[10rem] cursor-pointer hoverProduct" id="image1" src="<?= "../img/product/{$id}_image1.png" ?>" alt="">
                    <img class="w-[10rem] cursor-pointer hoverProduct" id="image2" src="<?= "../img/product/{$id}_image2.png" ?>" alt="">
                    <img class="w-[10rem] cursor-pointer hoverProduct" id="image3" src="<?= "../img/product/{$id}_image3.png" ?>" alt="">
                </div>
