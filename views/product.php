        ...
        <?php if ($quantity > 0) : ?>
            <div class="parent-container container min-h-screen pt-[5rem] pb-[1rem] relative">
                ...
                <div class="flex items-start pt-[1rem] px-[4rem] relative">
                    <div id="leftContainer" class="overflowYelement w-[9rem] flex flex-col sticky top-12 h-[37rem] overflow-y-auto">
                        <a href="#rimg1">
                    ...
                    <div id="rightContainer" class="flex flex-col ml-[4rem]">
                    ...
                    <form id="productForm" class="flex flex-col justify-start gap-6 sticky top-12 ml-[4rem] w-[26rem]">
                        ...
                        <div class="flex flex-col w-full gap-3">
                            <div class="flex gap-3 text-xs font-medium pl-[1px]">
                                <button type="button" id="dBtn2" class="underline uppercase">
                                    Description
                                </button>
                                <span>-</span>
                                <button type="button" id="dBtn1" class="uppercase">
                                    Delivery
                                </button>
                                <span>-</span>
                            ...
                            <!-- Static -->
                            <!-- prettier-ignore -->
                            <div id="desc1" class="hidden text-sm leading-6 h-[15rem] overflow-y-scroll whitespace-pre-line font-medium">Shipping to: International
                            ...
                            <!-- Dynamic -->
                            <!-- prettier-ignore -->
                            <div id="desc2" class="text-sm leading-6 h-[15rem] overflow-y-scroll whitespace-pre-line font-medium"><?= $description ?>,
