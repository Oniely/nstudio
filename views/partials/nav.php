<nav class="nav_bar border-b-[0.1px] border-[#101010] w-full h-[3rem] flex justify-between items-center px-[4rem] md:px-4 bottom-[-4.5rem] z-50" id="main_navbar">
    ...
    <ul class="flex gap-8 sm:gap-4 shrink-0 items-center">
        ...
        <li>
            ...
            <div id="alert-success" class="absolute top-[3rem] right-[1rem] opacity-0 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow" role="alert">
            ...
            <div id="alert-warning" class="absolute top-[3rem] right-[1rem] opacity-0 flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow" role="alert">
