...
<body class="min-h-screen">
    ...
    <main class="min-h-screen h-full pt-6 pb-10 md:pb-14 overflow-hidden animate__animated fadeIn">
        <div id="mainContainer" class="container min-h-screen pt-[4rem] px-[4rem] md:px-[2rem] sm:px-[1rem] flex flex-col gap-7 relative overflow-hidden">
                ...
                <div class="container h-auto pl-10 md:pl-0">
                    ...
                    <div class="w-full h-auto flex flex-col justify-center items-start gap-10">
                        <div class="w-full h-auto flex flex-col items-start gap-5">
                            ...
                            <div id="addressContainer" class="w-full h-full flex flex-wrap justify-start items-center gap-10">
                                <!-- Addresses -->
                            ...
                            <!-- Main modal -->
                            <div id="addressModal" tabindex="-1" aria-hidden="true" class="z-9 hidden overflow-y-auto overflow-x-hidden absolute inset-0 top-[3rem] md:top-[4rem] justify-center items-center h-[calc(100%-3rem)] md:h-[calc(100%-4rem)] max-h-full bg-white bg-opacity-80 backdrop-blur-sm">
                                <div class="relative p-4 w-full max-w-md max-h-full">
                                    ...
                                    <div class="relative rounded-lg shadow-sm bg-white border">
                                        ...
                                        <div class="flex items-center justify-between md:p-4 p-5 rounded-t">
                                            ...
                                            <button type="button" id="closeAddressBtn" class="z-50 text-gray-400 bg-transparent rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center hover:bg-white hover:text-black cursor-pointer" data-modal-toggle="crud-modal">
                                        ...
                                        <form class="p-4 md:p-5" method="POST">
                                            <div class="grid gap-4 mb-4 grid-cols-2">
                                                ...
                                                <div class="col-span-2">
                                                    <label for="street_name" class="block mb-2 text-sm font-medium text-black">Address /
                                                        Street Name</label>
                                                ...
                                                <div class="col-span-1">
                                                    <label for="contact_number" class="block mb-2 text-sm font-medium text-black">Contact
                                                        Number</label>
                        ...
                        <div class="relative mt-[10rem] mx-auto w-full max-w-md max-h-full">
                            <div class="relative rounded-lg shadow bg-white border">
                                ...
                                <div class="p-6 text-center">
                                    ...
                                    <button id="cancelBtn" data-modal-hide="popup-modal" type="button" class="focus:ring-4 focus:outline-none rounded-lg border text-sm font-medium px-5 py-2.5 focus:z-10 bg-gray-700 text-gray-300 border-gray-500 hover:text-white hover:bg-gray-800 focus:ring-gray-600">
                                        No,
                                        cancel
                                    </button>
                                </div>
