    ...
    <main class="w-full h-screen flex justify-center items-center py-10">
        <div class="container max-w-[25rem] border border-[#101010] flex flex-col items-center py-[1.5rem] shadow-lg">
            ...
            <form method="POST" id="signUpForm"
                class="w-full h-full flex flex-col items-center gap-[1.2rem] md:gap-[15px] text-[14px] text-[#101010]">
                <div class="w-full max-w-[18rem] flex flex-col relative">
                    <label class="text-[13px]" for="fname">First Name</label>
                    <input class="w-full h-full bg-slate-200 px-[10px] py-2" type="text" name="fname" id="fname"
                ...
                <div class="w-full max-w-[18rem] flex flex-col relative">
                    ...
                    <input class="w-full h-full bg-slate-200 px-[10px] py-2" type="text" name="lname" id="lname"
                        placeholder="Your Last Name" />
                    <span class="absolute bottom-[-1rem] left-0 text-xs text-[#ff0000] hidden"></span>
                </div>
                <div class="w-full max-w-[18rem] flex flex-col relative">
                    <label class="text-[13px]" for="contact">Contact Number</label>
                    <input class="w-full h-full bg-slate-200 px-[10px] py-2" type="text" name="contact" id="contact"
                ...
                <div class="w-full max-w-[18rem] flex flex-col relative">
                    ...
                    <input class="w-full h-full bg-slate-200 px-[10px] py-2 relative" type="password" name="confirmPass"
                        id="confirmPass" placeholder="Your Password">
                    <span class="absolute bottom-[-1rem] left-0 text-xs text-[#ff0000] hidden"></span>
                    <img data-visibility="invisible"
                        class="password_visibility absolute top-[1.6rem] right-[10px] cursor-pointer w-6 h-6"
                        src="img/p_invisible.png" alt="invisible">
                ...
                <div class="w-full max-w-[18rem] text-center">
                    ...
                    ?>
                    <span class="underline text-[12px] font-semibold">Already have an account? <a class="text-blue-800"
